...
export function SiteHeader({ backLinkLabel, lang, localePath = "/", variant }: SiteHeaderProps) {
  ...
  return (
    <header className={`${isLanding ? "absolute" : "relative"} top-0 left-0 z-10 h-header w-full border-b border-accent/20 bg-ui-footer/96 text-white max-stack:h-header-mobile`}>
      <div className="page-container relative flex h-full items-center justify-between max-stack:items-start max-stack:pt-3">
