          ...
          <div className="page-container relative z-10">
            <div className="non-landing-hero-copy-layout">
              <div className="min-w-0">
                <h1 className="m-0 max-w-full text-about-page-hero-title" id="page-title">{title}</h1>
                <p className="mt-7 max-w-full text-about-page-hero-body text-on-dark-muted">{intro}</p>
              </div>
            </div>
          </div>
        </section>
